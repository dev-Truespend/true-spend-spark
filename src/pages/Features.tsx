          ...
          <div className="space-y-32">
            ...
            <div className="space-y-12">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="group">
                  <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-muted/50 to-muted/30 p-6 h-full hover:shadow-premium transition-all duration-300 hover:scale-105 card-3d">
                    <img src={webOfflineMode} alt="Offline Mode" className="w-full h-48 object-cover rounded-lg mb-6" />
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 rounded-xl bg-brand-purple/10 flex items-center justify-center">
                        <CloudOff className="w-5 h-5 text-brand-purple" />
                      </div>
                      <h4 className="font-bold text-lg">Offline-First Architecture</h4>
                    </div>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Track expenses even without internet. All data syncs automatically when you're back online
                    </p>
                    <Badge variant="secondary" className="mt-4">Available Now</Badge>
                  </div>
                </div>
