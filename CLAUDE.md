...
| Analytics workflows | [06-insights-analytics.md](_docs/Workflows/06-insights-analytics.md), [10-geo-recommendations.md](_docs/Workflows/10-geo-recommendations.md), [10a-arrival-detection-provider.md](_docs/Workflows/10a-arrival-detection-provider.md) | Insights, location-aware recommendations, pluggable arrival detection (Foursquare SDK vs own-built) |
