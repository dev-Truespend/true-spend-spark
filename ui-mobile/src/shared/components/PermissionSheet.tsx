...
export function PermissionSheet({
  ...
  const styles = useThemedStyles((t) =>
    StyleSheet.create({
      ...
      title: { fontFamily: fontFamily.bold, fontWeight: "700", fontSize: scaleFont(17), color: t.colors.text },
      desc: { fontFamily: fontFamily.regular, fontSize: scaleFont(13), color: t.colors.mutedFg, textAlign: "center", lineHeight: 19, marginBottom: 10 },
    ...
    <Modal transparent visible={visible} animationType="slide" onRequestClose={onDeny}>
      <Pressable style={styles.overlay} onPress={onDeny}>
        <Pressable style={styles.sheet} onPress={() => undefined}>
          <View style={[styles.iconBox, { backgroundColor: t.tints.blue.bg }]}>
