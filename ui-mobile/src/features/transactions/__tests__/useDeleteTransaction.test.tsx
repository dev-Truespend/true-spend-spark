/* region: archive — useDeleteTransaction tests (removed from MVP)
 *
 * Manual transaction delete was removed from the MVP. The hook is preserved as
 * a no-op mutation that rejects; the tests for the original behaviour are
 * archived below.
 *
 ...
 *   transactionsApi: { deleteTransaction: jest.fn() }
 * }));
 *
 ...
 * }
 *
 * beforeEach(() => { transactionsApi.deleteTransaction.mockReset(); });
 *
...
describe.skip("useDeleteTransaction (archived — manual transaction delete removed from MVP)", () => {
  it("is archived", () => {
